      ...
      <section className="py-16 lg:py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold text-brand-dark tracking-tighter mb-4">
              About PocketDoc
            </h1>
      ...
      <section className="py-16 lg:py-24 bg-slate-50">
        <div className="container mx-auto px-4 max-w-4xl">
          <div className="grid md:grid-cols-1 gap-12">
            ...
            <div>
              <h2 className="text-2xl font-bold text-slate-800 mb-4">Technology Stack</h2>
              <p className="text-slate-600 leading-relaxed mb-4">
             ...
             <div>
                <h2 className="text-2xl font-bold text-slate-800 mb-4">Medical Disclaimer</h2>
